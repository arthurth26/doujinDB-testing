...
export const CircleContent = function CircleContent({circle, yearAndSeason}: {circle:circleData, yearAndSeason:string} ) {
        ...
        return (
            <li>
                <div id="circleContentContainer" className="p-2 rounded-xl bg-gray-700 text-gray-300" onClick={toggleDropDown}>
                    <h2 className="pb-2 font-semibold" > {parseInt(yearAndSeason.slice(0,4)) < 2025? `[${circle.realSp?.area}-${circle.realSp?.no}]`:`[${circle.area}-${circle.number}]`}  {circle.name}</h2>
                    <div className="relative flex flex-row items-center justify-between" >
                        <div id="pictureContainer" className="flex flex-row w-[333.25px]">
                        ...
                        <div id="LinksContainer" className="w-45" >
                                        ...
                                        <a href={link.url} className="cursor-pointer" target="_blank" rel="noopener noreferrer" key={index}>
                                            <li key={index} className="w-full rounded bg-gray-600 hover:bg-gray-300 p-1">
                                                <div className="flex flex-row gap-3 items-center">
                                                    ...
                                                    <span className="text-base">{URLhandler(link.url)}</span>
                                                </div>
                                            </li>
                                        </a>
                                    )}
